...
The CPU rasterizer uses the same unhinted outlines, pinned Zeno 0.3.3 8-bit grayscale nonzero-fill masks, a fixed 800-font-unit baseline and alpha composition over encoded sRGB channels. Three context hashes reproduce on macOS/aarch64, Linux/aarch64 and Linux/x86_64. The text entity remains `approximated` because line breaking and wrapping are not implemented.

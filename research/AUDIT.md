...
### Gate H — metadata-free collaboration checkpoints (complete for bounded register, existing-tree, concurrent-creation and complete-history compaction profiles)
